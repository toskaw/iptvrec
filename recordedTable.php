...
if(isset( $_GET['key']) ) {
	$options .= " AND autorec ='".mysqli_real_escape_string($dbh, trim($_GET['key']))."'";
}
...
if(isset( $_POST['do_search'] )) {
	if( isset($_POST['search'])){
		if( $_POST['search'] != "" ) {
			$search = $_POST['search'];
			 $options .= " AND CONCAT(title,description) like '%".mysqli_real_escape_string($dbh, $_POST['search'])."%'";
		}
	}
