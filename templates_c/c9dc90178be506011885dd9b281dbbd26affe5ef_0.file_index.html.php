<?php
/* Smarty version 5.5.1, created on 2025-08-21 23:59:49
  from 'file:index.html' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_68a73465079bb2_14670242',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c9dc90178be506011885dd9b281dbbd26affe5ef' => 
    array (
      0 => 'index.html',
      1 => 1755788367,
      2 => 'file',
...
function content_68a73465079bb2_14670242 (\Smarty\Template $_smarty_tpl) {
...
#contents {overflow-x: scroll;max-width: 100vw;}
...
.tvtime {
	height:<?php echo $_smarty_tpl->getValue('height_per_hour');?>
px;
	color:#EEE;
	text-align:center;
	font-weight:bold;
...
#tvtable div.ch_set {width:<?php echo $_smarty_tpl->getValue('ch_set_width');?>
px;float:left;background-color:#BBB;}
...
#tvtable div.ctg_, #category_select a.ctg_ {background-color: #E4F4F4;}
...
#float_titles div.ch_title {width:<?php echo $_smarty_tpl->getValue('ch_set_width');?>
px;float:left;color:#FFF;font-weight:bold;text-align:center}
...
<div id="float_titles" style="width: <?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('math')->handle(array('equation'=>"x + 80",'x'=>$_smarty_tpl->getValue('chs_width')), $_smarty_tpl);?>
px;height:120px;">
...
<div class="set">
  <ul>
    ...
    <li><a href="webapp.html">テレビ視聴</a></li>
  </ul>
</div>
...
?>
   <li><a href="javascript:CTG.select('<?php echo $_smarty_tpl->getValue('cat')['name_en'];?>
');" class="ctg_<?php echo $_smarty_tpl->getValue('cat')['name_en'];?>
"><?php echo $_smarty_tpl->getValue('cat')['name_jp'];?>
</a></li>
   <?php
}
...
?>
     <li <?php echo $_smarty_tpl->getValue('type')['selected'];?>
><a  class="jump" href="<?php echo $_smarty_tpl->getValue('type')['link'];?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
 ...
 <ul>
    <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('toptimes'), 'top');
$foreach2DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('top')->value) {
$foreach2DoElse = false;
?>
     <li><a class="jump" href="<?php echo $_smarty_tpl->getValue('top')['link'];?>
"><?php echo $_smarty_tpl->getValue('top')['hour'];?>
～</a></li>
    <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
 ...
 <span class="title">日付</span>
  <ul>
    <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('days'), 'day');
$foreach3DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('day')->value) {
$foreach3DoElse = false;
?>
     <li <?php echo $_smarty_tpl->getValue('day')['selected'];?>
><a <?php if ($_smarty_tpl->getValue('day')['d'] == "現在") {?> class="jump-today" <?php } else { ?> class="jump" <?php }?> href="<?php echo $_smarty_tpl->getValue('day')['link'];?>
"><?php echo $_smarty_tpl->getValue('day')['d'];
echo $_smarty_tpl->getValue('day')['ofweek'];?>
</a></li>
    <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
...
?>
  <div id="ch_title_<?php echo $_smarty_tpl->getValue('program')['ch_hash'];?>
"  class="ch_title<?php if ($_smarty_tpl->getValue('program')['skip'] == 1) {?> ch_title_skip<?php }?>" >
    <div class="ch_hash"><?php echo $_smarty_tpl->getValue('program')['ch_hash'];?>
</div>
    <div class="ch_disc"><?php echo $_smarty_tpl->getValue('program')['channel_disc'];?>
</div>
    <div class="ch_skip"><?php echo $_smarty_tpl->getValue('program')['skip'];?>
</div>
    <div class="ch_sid"><?php echo $_smarty_tpl->getValue('program')['sid'];?>
</div>
    <div class="ch_name"><?php echo $_smarty_tpl->getValue('program')['station_name'];?>
</div>
    <div id="ch_title_str_<?php echo $_smarty_tpl->getValue('program')['ch_hash'];?>
" <?php if ($_smarty_tpl->getValue('program')['skip'] == 1) {?>class="ch_skip_color" <?php }?> style="cursor: pointer;" onClick="javascript:PRG.chdialog('<?php echo $_smarty_tpl->getValue('program')['ch_hash'];?>
')" ><?php echo $_smarty_tpl->getValue('program')['station_name'];?>
</div>
  </div>
  <?php
}
...
<div id="tvtimes">
  <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('tvtimes'), 'time');
$foreach5DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('time')->value) {
$foreach5DoElse = false;
?>
  <div class="tvtime"><?php echo $_smarty_tpl->getValue('time');?>
</div>
  <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
...
<div id="tv_chs" style="width: <?php echo $_smarty_tpl->getValue('chs_width');?>
px" >
   <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('programs'), 'program');
$foreach6DoElse = true;
...
?>
   <div id="tv_chs_<?php echo $_smarty_tpl->getValue('program')['ch_hash'];?>
" class="ch_set<?php if ($_smarty_tpl->getValue('program')['skip'] == 1) {?> ch_set_skip<?php }?>" >
    <div class="ch_programs" >
    <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('program')['list'], 'item');
$foreach7DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('item')->value) {
$foreach7DoElse = false;
?>
      <div <?php if ($_smarty_tpl->getValue('item')['id']) {?>id="prgID_<?php echo $_smarty_tpl->getValue('item')['id'];?>
"<?php }?> class="prg <?php if (!$_smarty_tpl->getValue('item')['id']) {?>prg_none <?php }?> ctg_<?php echo $_smarty_tpl->getValue('item')['category_name'];
if ($_smarty_tpl->getValue('item')['rec'] > 0) {?> prg_rec<?php }?>" style="height:<?php echo $_smarty_tpl->getValue('item')['height'];?>
px;">
        <div class="prg_dummy">
          <div class="prg_title"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('item')['title'], ENT_QUOTES, 'UTF-8', true);?>
</div>
          <div class="prg_subtitle"><?php echo $_smarty_tpl->getValue('item')['starttime'];?>
</div>
          <div class="prg_desc"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('item')['description'], ENT_QUOTES, 'UTF-8', true);?>
</div>
          <div class="prg_channel"><?php echo $_smarty_tpl->getValue('item')['channel'];?>
</div>
          <div class="prg_start"><?php echo $_smarty_tpl->getValue('item')['prg_start'];?>
</div>
          <div class="prg_duration"><?php echo $_smarty_tpl->getValue('item')['duration'];?>
</div>
          <div class="prg_id"><?php echo $_smarty_tpl->getValue('item')['id'];?>
</div>
        </div>
      </div>
    <?php
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
 ...
 <div id="tvtimes2" style="top : 0px; left: <?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('math')->handle(array('equation'=>"x + 40",'x'=>$_smarty_tpl->getValue('chs_width')), $_smarty_tpl);?>
px" >
  <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('tvtimes'), 'time');
$foreach8DoElse = true;
...
var INISet = {
	...
	dotMin : <?php echo $_smarty_tpl->getValue('height_per_min');?>
,
	tableStartTime : '<?php echo $_smarty_tpl->getValue('top_time');?>
',
	tableEndTime : '<?php echo $_smarty_tpl->getValue('last_time');?>
',
	ch_width : <?php echo $_smarty_tpl->getValue('ch_set_width');?>
,
	num_ch : <?php echo $_smarty_tpl->getValue('num_ch');?>
,
	num_all_ch : <?php echo $_smarty_tpl->getValue('num_all_ch');?>
